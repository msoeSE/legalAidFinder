...
test('renders properly', t => {
  ...
  t.is(wrapper.find('Header').prop('toggleAddCategory'), wrapper.instance().toggleAddCategorySection);
...
test('calling toggleAddCategorySection dispatches toggleAddCategory', t => {
  const wrapper = shallow(
    <App {...props} />
  );

  wrapper.instance().toggleAddCategorySection();
