...
if (process.env.NODE_ENV !== 'production') {
  ...
  require('./modules/Category/pages/CategoryDetailPage/CategoryDetailPage');
}
...
export default (
  <Route path="/" component={App}>
    ...
    <Route
      ...
      getComponent={(nextState, cb) => {
        require.ensure([], require => {
          cb(null, require('./modules/Category/pages/CategoryDetailPage/CategoryDetailPage').default);
        });
      }}
    />
    <Route
